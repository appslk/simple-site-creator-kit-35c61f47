...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-purple-900/30 bg-background/90">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="flex flex-col md:flex-row justify-between mb-12">
          <div className="mb-8 md:mb-0">
            ...
            <p className="text-gray-400 max-w-xs">
              Building the next generation ecosystem on Scroll with NFTs, rewards, games, and community.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">TalentDAO</a></li>
        ...
        <div className="border-t border-purple-900/30 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © {currentYear} ScrollVerse. All rights reserved.
          </p>
