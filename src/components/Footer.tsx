...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-pink-900/30 bg-background/90">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="border-t border-pink-900/30 pt-8 flex flex-col md:flex-row items-center justify-between">
